...
{
  pool reserve /*of Gold*/ at 50 //was 100 //Gold reserve (starts at 100)
  ...
  user all converter buyDefence /*from Gold to Defence*/ //convert all required Gold to Defence
  user all converter buyAttack /*from Gold to Attack*/   //convert all required Gold to Attack
  user all converter buyFactory /*from Gold to Factory*/ //convert all required Gold to Factory

  reserve -factories/**0.25*/ + 1-> resources //flow 0.25 * factories Gold to resources
  resources -3-> buyFactory      //buyFactory consumes 5 Gold from resources
...
Turtle(ref buyAttack, ref buyDefence, ref buyFactory)
{
  ...
  count .<=6.> chooseDefence
  count .>6 && <15.> chooseFactory
  count .>=15.> chooseAttack
